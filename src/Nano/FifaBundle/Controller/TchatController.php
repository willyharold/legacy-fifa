...
use Nano\FifaBundle\Form\TchatType;
...
class TchatController extends Controller
{
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('NanoFifaBundle:Tchat')->findAll();
        return $entities;
    }
    ...
    public function findAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Tchat')->find($request->get('id'));
        if (empty($entity)) {
    ...
    public function createAction(Request $request) {
        $entity = new Tchat();
        $form = $this->createForm(TchatType::class, $entity);
    ...
    public function removeAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Tchat')
            ->find($request->get('id'));
