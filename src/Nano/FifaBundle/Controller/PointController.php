...
use Nano\FifaBundle\Form\PointType;
...
class PointController extends Controller
{
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('NanoFifaBundle:Point')->findAll();
        return $entities;
    }
    ...
    public function findAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Point')->find($request->get('id'));
        if (empty($entity)) {
    ...
    public function createAction(Request $request) {
        $entity = new Point();
        $form = $this->createForm(PointType::class, $entity);
    ...
    public function removeAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Point')
            ->find($request->get('id'));
