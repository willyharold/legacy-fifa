...
use Nano\FifaBundle\Form\SuggestionType;
...
class SuggestionController extends Controller
{
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('NanoFifaBundle:Suggestion')->findAll();
        return $entities;
    }
    ...
    public function findAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Suggestion')->find($request->get('id'));
        if (empty($entity)) {
    ...
    public function createAction(Request $request) {
        ...
        $form = $this->createForm(SuggestionType::class, $entity);
    ...
    public function removeAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Suggestion')
            ->find($request->get('id'));
