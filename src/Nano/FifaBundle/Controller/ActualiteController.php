...
use Nano\FifaBundle\Form\ActualiteType;
...
class ActualiteController extends Controller
{
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('NanoFifaBundle:Actualite')->findAll();
        return $entities;
    }
    ...
    public function findAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Actualite')->find($request->get('id'));
        if (empty($entity)) {
    ...
    public function removeAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('NanoFifaBundle:Actualite')
            ->find($request->get('id'));
